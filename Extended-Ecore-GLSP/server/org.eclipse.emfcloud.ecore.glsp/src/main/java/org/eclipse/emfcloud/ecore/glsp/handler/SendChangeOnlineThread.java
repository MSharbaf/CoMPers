...
public class SendChangeOnlineThread implements Runnable  {

	   Thread t;
	   SocketPacket tsp ; 
	   
	   SendChangeOnlineThread(SocketPacket sp) {
	    
	      // thread created
	      t = new Thread(this, "Send Change Online Thread");
	   ...
	   public void run() {
		...
		public void sendSocket(SocketPacket sp) {
